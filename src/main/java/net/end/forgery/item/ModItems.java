...
public class ModItems {
    ...
    public static final Item ENDER_BOW = registerItem("ender_bow", (new net.minecraft.item.BowItem (new Item.Settings().maxDamage(8))));
    public static final Item SWIRLING_WINDS = registerItem("swirling_winds", (new net.minecraft.item.BowItem (new Item.Settings().maxDamage(10))));
