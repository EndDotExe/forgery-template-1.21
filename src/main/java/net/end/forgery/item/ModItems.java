...
public class ModItems {
    ...
    public static final Item BLIGHTED_BLADE = registerItem("blighted_blade", (new net.end.forgery.item.custom.PoisonSwordItem(ToolMaterials.NETHERITE, (new Item.Settings()).rarity(Rarity.UNCOMMON).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE, 5, -2.0F)))));
    public static final Item FRIGID_FLAMBERGE = registerItem("frigid_flamberge", (new net.end.forgery.item.custom.SlownessSwordItem(ToolMaterials.NETHERITE, (new Item.Settings()).rarity(Rarity.UNCOMMON).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE, 5, -2.0F)))));
    public static final Item EDGE_OF_FRAILTY = registerItem("edge_of_frailty", (new net.end.forgery.item.custom.WeaknessSwordItem(ToolMaterials.NETHERITE, (new Item.Settings()).rarity(Rarity.UNCOMMON).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE, 5, -2.0F)))));
