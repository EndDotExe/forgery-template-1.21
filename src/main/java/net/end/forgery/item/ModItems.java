...
public class ModItems {
    ...
    public static final Item VITALITYS_THIEF = registerItem("vitality_thief", (new net.end.forgery.item.custom.VampiricSwordItem(ModToolMaterials.FORGERY_UPGRADED, (new Item.Settings()).rarity(Rarity.RARE).attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.FORGERY_UPGRADED, 0, -3.25F)))));
