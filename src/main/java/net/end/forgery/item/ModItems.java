...
import net.end.forgery.item.custom.PoisonSwordItem;
...
public class ModItems {
    ...
    public static final Item BEDEVILLED_BLADE = registerItem("bedevilled_blade", new PoisonSwordItem(new PoisonSwordItem(ToolMaterials.NETHERITE, (new Item.Settings()).rarity(Rarity.RARE).attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.NETHERITE, 4.0F, -2.0F)))));
